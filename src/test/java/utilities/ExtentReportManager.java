...
public class ExtentReportManager implements ITestListener {
	...
	public void onStart(ITestContext context) {
		...
		String timeStamp = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new Date());// time stamp for the report.
	...
	public void onFinish(ITestContext context) {
		...
		// After generating report it will automatically open
		...
		// email sending after report generation
...
//			email.setAuthenticator(new DefaultAuthenticator("mahesh.purplefront@gmail.com", "Open@123"));
//			email.setSSLOnConnect(true);
//			email.setFrom("mahesh.purplefront@gmail.com"); // Sender
//			email.setSubject("Test Results");
//			email.setMsg("Please find Attached Report...");
//			email.addTo("mahe.sorab@gmail.com"); // Receiver
